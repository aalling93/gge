...
class CFSV2Data(SatelliteData):
    def __init__(
        ...
        variables: list = ["Temperature_surface"],
    ):
    ...
    def download_data(self):
        collection_id = "NOAA/CFSV2/FORECAST"
        collection = (
    ...
    def __repr__(self):
        return f"<CFSV2Data covering area {self.area} from {self.time_range[0]} to {self.time_range[1]}>"

    def __str__(self):
        return "CFSV2 Data Handler"
